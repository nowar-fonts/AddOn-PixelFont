...
function GlobalFont.Register(this, event, ...)
	...
	if SystemFont_Shadow_Huge4 then SystemFont_Shadow_Huge4:SetFont(GlobalFont.DefaultFont, GlobalFont.CalculateFontSize(27, 27), "MONOCHROME") end
	if SystemFont_Shadow_Outline_Huge4 then SystemFont_Shadow_Outline_Huge4:SetFont(GlobalFont.DefaultFont, GlobalFont.CalculateFontSize(27, 27), "OUTLINE,MONOCHROME") end
	...
	if Number11Font then Number11Font:SetFont(GlobalFont.ChatFont, GlobalFont.CalculateFontSize(11, 10), "MONOCHROME") end
	if Number12Font then Number12Font:SetFont(GlobalFont.ChatFont, GlobalFont.CalculateFontSize(12, 11), "MONOCHROME") end
	if Number13Font then Number13Font:SetFont(GlobalFont.ChatFont, GlobalFont.CalculateFontSize(13, 12), "MONOCHROME") end
	if PriceFont then PriceFont:SetFont(GlobalFont.ChatFont, GlobalFont.CalculateFontSize(14, 14), "MONOCHROME") end
	if Number15Font then Number15Font:SetFont(GlobalFont.ChatFont, GlobalFont.CalculateFontSize(15, 14), "MONOCHROME") end
	if Number18Font then Number18Font:SetFont(GlobalFont.ChatFont, GlobalFont.CalculateFontSize(18, 17), "MONOCHROME") end
	...
	if FriendsFont_11 then FriendsFont_11:SetFont(GlobalFont.DefaultFont, GlobalFont.CalculateFontSize(11, 14), "MONOCHROME") end
